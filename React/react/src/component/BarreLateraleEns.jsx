            ...
            <aside id="sidebar" className="sidebar">
                ...
                <ul className="sidebar-nav" id="sidebar-nav">
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link " to="/dashboard_ens">
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse"
                                 to="/enseignant/fiche_cours">
                            <i className="bi bi-layout-text-window-reverse"></i><span>Fiche de cours</span><i
                            className="bi bi-chevron-down ms-auto"></i>
                        </NavLink>
                        <ul id="tables-nav" className="nav-content collapse" data-bs-parent="#sidebar-nav">
                            <li>
                                <NavLink to="/enseignant/fiche_cours">
                                    <i className="bi bi-circle"></i><span>Fiche de cours</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/fiche_cours_supprimer">
                                    <i className="bi bi-circle"></i><span>Corbeille</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/fiche_cours_archiver">
                                    <i className="bi bi-circle"></i><span>Archives</span>
                                </NavLink>
                            </li>
                        </ul>
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse"
                                 to="/performance_enseignant">
                            <i className="bi bi-bar-chart"></i><span>Performances</span><i
                            className="bi bi-chevron-down ms-auto"></i>
                        </NavLink>
                        <ul id="charts-nav" className="nav-content collapse" data-bs-parent="#sidebar-nav">
                            <li>
                                <NavLink to="/performance_enseignant">
                                    <i className="bi bi-circle"></i><span>Performances</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/enseignant/performance_supprimer">
                                    <i className="bi bi-circle"></i><span>Corbeille</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/enseignant/performance_archiver">
                                    <i className="bi bi-circle"></i><span>Archives</span>
                                </NavLink>
                            </li>
                        </ul>
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse"
                                 to="/paiement_enseignant">
                            <i className="bi bi-bar-chart"></i><span>Paiements</span><i
                            className="bi bi-chevron-down ms-auto"></i>
                        </NavLink>
                        <ul id="icons-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <li>
                                <NavLink to="/paiement_enseignant">
                                    <i className="bi bi-circle"></i><span>Paiements</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/paiement_enseignant_supprimer">
                                    <i className="bi bi-circle"></i><span>Corbeille</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/paiement_enseignant_archiver">
                                    <i className="bi bi-circle"></i><span>Archives</span>
                                </NavLink>
                            </li>
                        </ul>
                    ...
                    <li className="nav-item">
                        ...
                        <ul id="slides-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <li>
                                <NavLink to="/conge_enseignant">
                                    <i className="bi bi-circle"></i><span>Congés</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/enseignant/conge_supprimer">
                                    <i className="bi bi-circle"></i><span>Corbeille</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/enseignant/conge_archiver">
                                    <i className="bi bi-circle"></i><span>Archives</span>
                                </NavLink>
                            </li>
                        </ul>
                    ...
                    <li className="nav-item">
                        ...
                        <ul id="logo-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <li>
                                <NavLink to="/carriere_enseignant">
                                    <i className="bi bi-circle"></i><span>Carrière</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/enseignant/carriere_supprimer">
                                    <i className="bi bi-circle"></i><span>Corbeille</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/enseignant/carriere_archiver">
                                    <i className="bi bi-circle"></i><span>Archives</span>
                                </NavLink>
                            </li>
                        </ul>
...
export default BarreLateraleEns;