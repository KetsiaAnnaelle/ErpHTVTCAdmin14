...
function MyVerticallyCenteredModal(props) {
    ...
    const updateConge = async (data) => {
        ...
        await axios.post(`${import.meta.env.VITE_URL}/congeEns/${props.data.id}`,{
            'typeConge': data.type,
            'dateDeb': data.deb,
            'dateFin': data.fin,
        })
...
// fonction pour lister les abscences
    ...
    async function getConges() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/congeEnss`);
...
// fonction pour créer un personnel
    ...
    const onSubmit = async (data) => {
        ...
        axios.post(`${import.meta.env.VITE_URL}/congeEnss`,formData)
            .then(function (response) {
                console.log(response.data);
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/congeEns/elementRestaures`, { ids: selectedRecords })
            .then(function (response) {
        ...
        swal({
            ...
            .then((value) => {
                if (value === "supprimer") {
                    ...
                    axios
                        .put(`${import.meta.env.VITE_URL}/congeEns/${id}/archiver`, { archiver: 1 })
                        .then(function(response) {
                                                                    ...
                                                                    <Row className='d-flex justify-content-center mb-3'>
                                                                        ...
                                                                        <Col className='col-md-2'>
                                                                            ...
                                                                            <Form.Select aria-label="Default select example" className='mb-3' value={selectedPerso} onChange={(e) => setSelectedPerso(e.target.value)}>
                                                                                ...
                                                                                {
                                                                                    cong.length !== 0 && (
                                                                                        [...new Set(cong.map((element) => element.nomEns +' '+ element.prenomEns))].map((nom, index) => {
                                                                                            return (
