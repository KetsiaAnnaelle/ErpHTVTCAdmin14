...
const ConduiteArchive = () => {
    ...
    async function getConduitesArchiver() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/conduitesArchiver`);
    ...
    const delConduite = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    // Pour mettre à jour le champ 'supprimer' de le conduite en le mettant à 1
                    axios
    ...
    const restaurerConduite = async (id) => {
        swal({
            ...
            text: "Elle reviendra dans la liste des conduites !",
            icon: "warning",
            buttons: {
                        ...
                        <div className="pagetitle">
                            ...
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/conduite">Conduites</NavLink></li>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste des rapports de conduite archivé</h3>
                                            </div>
                                                                                        ...
                                                                                        <tr key={index}>
                                                                                            ...
                                                                                            <td>
                                                                                                {['bottom'].map((placement) => (
                                                                                                    ...
                                                                                                    >
                                                                                                        <Button variant="transparent" className='mb-3 ms-3' onClick={()=>restaurerConduite(element.id)} ><AiFillCheckCircle className='text-success me-1'  style={{ cursor:'pointer' }}/></Button>
                                                                                                    </OverlayTrigger>
                                                                                                ))}
                                                                                            </td>
                                                                                            <td>
...
export default ConduiteArchive;