...
const PerformanceSupprimer = () => {
    ...
    async function getPerformancesSupprimer() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/performancesSupprimer`);
    ...
    const delPerformance = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    axios
                        .delete(`${import.meta.env.VITE_URL}/performance/` + id)
    ...
    const restaurerPerformance = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    // Pour mettre à jour le champ 'supprimer' la performance en le mettant à 1
                    axios
                ...
                <Col className='col-lg-12'>
                    <main id="main" className="main">
                        ...
                        <div className="pagetitle">
                            <h1>Corbeille des performances</h1>
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/performance">Performance</NavLink></li>
                                    <li className="breadcrumb-item active">Corbielle Performances</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste des performances dans la corbeille</h3>
                                            </div>
                                                ...
                                                <Form className='d-flex justify-content-center my-3'>
                                                        ...
                                                        <OverlayTrigger
                                                            ...
                                                            overlay={
                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                    <strong>Supprimer plusieurs Performances définitivement</strong>.
                                                                </Tooltip>
                                                            }
                                                        >
                                                    ...
                                                    {['bottom'].map((placement) => (
                                                        <OverlayTrigger
                                                            ...
                                                            overlay={
                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                    <strong>Restaurer plusieurs performances</strong>.
                                                                        ...
                                                                        <tr key={index}>
                                                                            ...
                                                                            <td>
                                                                                {['bottom'].map((placement) => (
                                                                                    ...
                                                                                    >
                                                                                        <Button variant="transparent" className='mb-3 ms-3' onClick={()=>restaurerPerformance(element.id)} ><AiFillCheckCircle className="text-success" style={{ cursor:'pointer' }} /></Button>
                                                                                    </OverlayTrigger>
                                                                                ))}
                                                                            </td>
                                                                            <td>
...
export default PerformanceSupprimer;