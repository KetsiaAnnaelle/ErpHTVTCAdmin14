...
const ArchiveConge = () => {
    ...
    async function getCongesArchiver() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/congesArchiver`);
        ...
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    ...
                    axios
                        .put(`${import.meta.env.VITE_URL}/conge/${id}/archiverRestaurer`, { archiver: 0 })
                        .then(function(response) {
    ...
    const handleRestaureSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/conge/elementRestaure`, { ids: selectedRecords })
            .then(function (response) {
