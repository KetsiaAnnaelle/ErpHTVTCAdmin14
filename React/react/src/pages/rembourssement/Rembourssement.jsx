...
function MyVerticallyCenteredModal(props) {
    ...
    const updateFacture = async (data) => {
        ...
        await axios.post(`${import.meta.env.VITE_URL}/rembourssement/${props.data.id}`,{
            'total': data.total,
            'paye': data.paye,
...
const Rembourssement = () => {
    ...
    async function getRemboursement() {
        try {
            setload(true)
            const response = await axios.get(`${import.meta.env.VITE_URL}/rembourssements`);
    ...
    const onSubmit = async (data) => {
        ...
        axios.post(`${import.meta.env.VITE_URL}/rembourssements`,formData)
            .then(function (response) {
                console.log(response.data);
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/rembourssement/elementRestaures`, { ids: selectedRecords })
            .then(function (response) {
    ...
    const handleSupprimeSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/rembourssement/elementSupprime`, { ids: selectedRecords })
            .then(function (response) {
    ...
    const delFacture = async (id) => {
        swal({
            ...
            .then((value) => {
                if (value === "supprimer") {
                    // Pour mettre à jour le champ 'supprimer' de la facture en le mettant à 1
                    axios
                        .put(`${import.meta.env.VITE_URL}/rembourssement/${id}/supprimer`, { supprimer: 1 })
                        .then(function(response) {
                    ...
                    // Pour mettre à jour le champ 'archiver' de la facture en le mettant à 1
                    axios
                        .put(`${import.meta.env.VITE_URL}/rembourssement/${id}/brouillon`, { archiver: 1 })
                        .then(function(response) {
                            swal("Archivé!", "Votre facture a été marquée comme archivé.", "success");
                            window.location.reload();
                        })
                        .catch(function(error) {
                            console.error(error);
                    ...
                    swal("Annulé", "Votre facture n'a pas été modifié.", "info");
                }
            })
            .catch(function(error) {
                console.error(error);
                        ...
                        <div className="pagetitle">
                            ...
                            <nav>
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Remboursement</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Listes des Remboursements</h3>
                                            </div>
                                                                ...
                                                                <Form className='d-flex justify-content-center my-3'>
                                                                    ...
                                                                    {['right'].map((placement) => (
                                                                        <OverlayTrigger
                                                                            ...
                                                                            overlay={
                                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                                    <strong>Filtrer les Remboursements</strong>.
                                                                                </Tooltip>
                                                                            }
                                                                        >
                                                                    ...
                                                                    {['bottom'].map((placement) => (
                                                                        ...
                                                                        >
                                                                            <Link variant="transparent" to={'/fact/fact_archiver'} className='btn btn-transparent'>Brouillon</Link>
                                                                        </OverlayTrigger>
                                                                    ))}
                                                                    {['bottom'].map((placement) => (
                                                                        <OverlayTrigger
                                                                            ...
                                                                            overlay={
                                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                                    <strong>Voir corbeille Remboursement</strong>.
                                                                                </Tooltip>
                                                                            }
                                                                        >
                                                                                    ...
                                                                                    <tr key={index}>
                                                                                        ...
                                                                                        <td>
                                                                                            {['bottom'].map((placement) => (
                                                                                                ...
                                                                                                >
                                                                                                    <Button variant="transparent" className='mb-3 ms-3' >  <Link to={`/fact/detail_facture/${element.id}`}><FaEye className="text-warning" style={{ cursor:'pointer' }} /></Link></Button>
                                                                                                </OverlayTrigger>
                                                                                            ))}
                                                                                        </td>
                                                                                        <td>{formatdate}</td>
                                                                                        ...
                                                                                        <td>
                                                                                            {['bottom'].map((placement) => (
                                                                                                <OverlayTrigger
                                                                                                    ...
                                                                                                    overlay={
                                                                                                        <Tooltip id={`tooltip-${placement}`}>
                                                                                                            <strong>Modifier Remboursement</strong>.
                                                                                                        </Tooltip>
                                                                                                    }
                                                                                                >
            ...
            <Modal show={show} size="lg" onHide={handleClose} aria-labelledby="contained-modal-title-vcenter" centered>
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit(onSubmit)} encType='multipart/form-data format'>
                        ...
                        <Form.Select aria-label="Default select example" {...register("status", { required: true })} className='mb-3'controlId="" >
                            <option>Choisir le Statut</option>
                            <option value="Réglé">Réglé</option>
                            <option value="Partiellement Réglé">Partiellement Réglé</option>
                            <option value="Rembourssement">Rembourssement</option>
