...
const RemboussementBrouillon = () => {
    ...
    async function getRembourssementArchiver() {
        try {
            const response = await axios.get('http://localhost:8000/api/rembourssementsArchiver');
    ...
    const delRembourssement = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    // Pour mettre à jour le champ 'supprimer' de le rembourssement en le mettant à 1
                    axios
                        .put(`http://localhost:8000/api/rembourssement/${id}/supprimer`, { supprimer: 1 })
        ...
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    ...
                    axios
                        .put(`http://localhost:8000/api/rembourssement/${id}/archiverRestaurer`, { archiver: 0 })
                        .then(function(response) {
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`http://localhost:8000/api/elementRestaures`, { ids: selectedRecords })
            .then(function (response) {
    ...
    const handleSupprimeSelected = () => {
        ...
        axios.put(`http://localhost:8000/api/elementSupprime`, { ids: selectedRecords })
            .then(function (response) {
                swal("Supprimées !", "Les rembourssements sélectionnées ont été supprimées.", "success");
                window.location.reload();
            })
            .catch(function (error) {
                console.error(error);
    ...
    const handleDeleteSelected = () => {
        ...
        if (check.length==0 || selectedRecords.length==0){
            <Alert variant="danger">
                <Alert.Heading>Cocher au moins un rembourssement</Alert.Heading>
            </Alert>
        }else {
            axios.post('http://localhost:8000/api/element', {
                        ...
                        <div className="pagetitle">
                            ...
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/">Rembourssement</NavLink></li>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste des archives de rembourssement</h3>
                                            </div>
                                                                        ...
                                                                        <OverlayTrigger
                                                                            ...
                                                                            overlay={
                                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                                    <strong>Supprimer plusieurs remboursements</strong>.
                                                                                </Tooltip>
                                                                            }
                                                                        >
                                                                                    ...
                                                                                    <tr key={index}>
                                                                                        ...
                                                                                        <td>
                                                                                            {['bottom'].map((placement) => (
                                                                                                ...
                                                                                                >
                                                                                                    <Button variant="transparent" className='mb-3 ms-3' onClick={()=>restaurerRembourssement(element.id)} ><FaEdit className='text-primary me-1'  style={{ cursor:'pointer' }}/></Button>
                                                                                                </OverlayTrigger>
                                                                                            ))}
                                                                                        </td>
                                                                                        <td>
...
export default RemboussementBrouillon;