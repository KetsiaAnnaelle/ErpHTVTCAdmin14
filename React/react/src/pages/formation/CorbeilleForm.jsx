...
const CorbeilleForm = () => {
    ...
    async function getFormationsSupprimer() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/formsSupprimer`);
    ...
    const delFormation = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    axios
                        .delete(`${import.meta.env.VITE_URL}/form/` + id)
    ...
    const restaurerFormation = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    // Pour mettre à jour le champ 'supprimer' du formation en le mettant à 1
                    axios
    ...
    const handleRestaureSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/form/elementRestaure`, { ids: selectedRecords })
            .then(function (response) {
                swal("Restaurées !", "Les formations sélectionnées ont été restauré.", "success");
                window.location.reload();
            })
            .catch(function (error) {
                console.error(error);
    ...
    const handleDeleteSelected = () => {
        ...
        if (check.length==0 || selectedRecords.length==0){
            ...
            axios.put(`${import.meta.env.VITE_URL}/form/element`, {
                data: selectedRecords,
            })
                .then(function (response) {
                    swal("Supprimées !", "Les formation sélectionnées ont été supprimé définitivement.", "success");
                    window.location.reload();
                        ...
                        <div className="pagetitle">
                            ...
                            <nav>
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Corbeilles</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste des formations dans la corbeille</h3>
                                            </div>
