...
const NoteCorbeille = () => {
 ...
 async function getNotesCorbeille() {
 try {
 setload(true)
 const response = await axios.get(`${import.meta.env.VITE_URL}/get_note-corbeille`);
 ...
 try {
 const response = axios.delete(`${import.meta.env.VITE_URL}/force-delete_note/${id}`);
 ...
 <h3 className="card-title">Liste des Notes dans la corbeille</h3>
 </div>
