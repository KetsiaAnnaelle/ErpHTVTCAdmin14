...
function MyVerticallyCenteredModal(props) {
    ...
    const updatePersonnel = async (data) => {
        ...
        await axios.post(`http://localhost:8000/api/personnel/${props.data.id}`,{
            'nomPerso': data.nom,
...
// fonction pour créer un personnel
    ...
    const onSubmit = async (data) => {
        ...
        axios.post('http://localhost:8000/api/personnels',formData)
            .then(function (response) {
                console.log(response.data);
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`http://localhost:8000/api/personnel/elementRestaures`, { ids: selectedRecords })
            .then(function (response) {
    ...
    const handleSupprimeSelected = () => {
        ...
        axios.put(`http://localhost:8000/api/personnel/elementSupprime`, { ids: selectedRecords })
            .then(function (response) {
        ...
        swal({
            ...
            .then((value) => {
                if (value === "supprimer") {
                    ...
                    axios
                        .put(`http://localhost:8000/api/personnel/${id}/supprimer`, { supprimer: 1 })
                        .then(function(response) {
                    ...
                    axios
                        .put(`http://localhost:8000/api/personnel/${id}/archiver`, { archiver: 1 })
                        .then(function(response) {
    ...
    return (
        <Container fluid>
                        ...
                        <div className="pagetitle">
                            ...
                            <nav>
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Recrutement du Personnel</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste du personnel recruté</h3>
                                            </div>
                                                ...
                                                <Form className='d-flex justify-content-center my-3' >
                                                    ...
                                                    {['bottom'].map((placement) => (
                                                        <OverlayTrigger
                                                            ...
                                                            overlay={
                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                    <strong>Archiver plusieurs recrutements</strong>.
                                                                </Tooltip>
                                                            }
                                                        >
                                                    ...
                                                    <tr style={{backgroundColor: '#1A3C30', borderBottomColor:'transparent'}} className='w-100'>
                                                        {['right'].map((placement) => (
                                                            <OverlayTrigger
                                                                ...
                                                                overlay={
                                                                    <Tooltip id={`tooltip-${placement}`}>
                                                                        <strong>Créer un personnel</strong>.
                                                                    </Tooltip>
                                                                }
                                                            >
                                                                            ...
                                                                            <td>
                                                                                {['bottom'].map((placement) => (
                                                                                    <OverlayTrigger
                                                                                        ...
                                                                                        overlay={
                                                                                            <Tooltip id={`tooltip-${placement}`}>
                                                                                                <strong>Modifier personnel</strong>.
                                                                                            </Tooltip>
                                                                                        }
                                                                                    >
            ...
            <Modal show={show} size="lg" onHide={handleClose} aria-labelledby="contained-modal-title-vcenter" centered>
                ...
                <Modal.Header closeButton className='bg-secondary text-white'>
                    <Modal.Title id="contained-modal-title-vcenter" className='fw-4'>Ajouter un recrutement</Modal.Title>
                </Modal.Header>
