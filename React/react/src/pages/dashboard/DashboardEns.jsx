...
const DashboardEns = () => {
    ...
    } async function getPaiementEns() {
        try {
            const dataSet2 = []
            const response1 = await axios.get(`${import.meta.env.VITE_URL}/paiementEnss`)
            setpaie(response1.data);
            for(const val of paie){
                dataSet2.push(val.MontantPaiementEns)
            }
                                    ...
                                    <div className="row">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        ...
                                                        <div className="ps-3">
                                                            {paie.map((element, index) => {
                                                                totalPaie=totalPaie+element.MontantPaiementEns;
                                                            })}
                                        ...
                                        <div className='col-xxl-4 col-md-6'>
                                            <div className="card info-card revenue-card">
                                                ...
                                                <div className="card-body">
                                                    <h5 className="card-title">Nombre Enseignant </h5>
                                        ...
                                        <div className="col-md">
                                            ...
                                            <div className="card info-card customers-card">
                                                ...
                                                <div className="card-body">
                                                    ...
                                                    <div>
                                                        <Bar data={data} options={options}>Dashboard Enseignant </Bar>
                                                    </div>
                                                ...
                                                <table className="table table-borderless datatable">
                                                    ...
                                                    {paie.map((element, index) => {
                                                        return (
                                                            <>
                                                                <tr>
                                                                    <td>{element.RefPaiementEns}</td>
                                                                    <td>{element.nomEns+' '+element.prenomEns}</td>
                                                                    <td className='text-success fw-bold '>{element.MontantPaiementEns}</td>
                                                                    <td>{element.MoyenPaiementEns}</td>
                                                                    <td>{element.MotifPaiementEns}</td>
                                                                    <td className='text-danger fw-bold'>{element.ProchainPaiementEns}</td>
                                                                </tr>
                                                            </>
                                                        )
                                                    })}
