...
// fonction pour lister les abscences
    ...
    async function getFicheCours() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/ficheCoursArchiver`);
    ...
    const handleSupprimeSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/ficheCour/elementSupprime`, { ids: selectedRecords })
            .then(function (response) {
                swal("Supprimé !", "Les fiches de cours sélectionnées ont été supprimé.", "success");
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/ficheCour/elementRestaure`, { ids: selectedRecords })
            .then(function (response) {
                swal("Restauré !", "Les fiches de cours sélectionnés ont été restauré.", "success");
                window.location.reload();
            })
            .catch(function (error) {
                console.error(error);
                ...
                <Col className='col-lg-12'>
                    <main id="main" className="main">
                        ...
                        <div className="pagetitle">
                            <h1>Fiches de cours archivées</h1>
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/personnel/fiche_travail">Fiches de cours</NavLink></li>
                                    <li className="breadcrumb-item active">Fiches de cours archivées</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste des fiches de cours archivées</h3>
                                            </div>
...
export default ArchiveFicheCours;