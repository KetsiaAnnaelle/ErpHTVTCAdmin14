...
function MyVerticallyCenteredModal(props) {
    ...
    const updatePersonnel = async (data) => {
        ...
        await axios.post(`${import.meta.env.VITE_URL}/ficheCour/${props.data.id}`,{
...
// fonction pour lister les abscences
    ...
    async function getFicheCours() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/ficheCours`);
...
// fonction pour créer un personnel
    ...
    const onSubmit = async (data) => {
        ...
        axios.post(`${import.meta.env.VITE_URL}/ficheCours`,formData)
            .then(function (response) {
                console.log(response.data);
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/ficheCour/elementRestaures`, { ids: selectedRecords })
            .then(function (response) {
                swal("Archivé !", "Les Fiches de cours sélectionnés ont été archivé.", "success");
                window.location.reload();
            })
            .catch(function (error) {
                console.error(error);
    ...
    const handleSupprimeSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/ficheCour/elementSupprime`, { ids: selectedRecords })
            .then(function (response) {
                swal("Supprimé !", "Les fiches de cours sélectionnés ont été supprimé.", "success");
                window.location.reload();
            })
            .catch(function (error) {
                console.error(error);
...
// fonction pour supprimer un personnel
    ...
    const delPersonnel = async (id) => {
        swal({
            ...
            text: "Vous risquez de ne plus pouvoir restaurer cette fiche !",
            icon: "warning",
            buttons: {
                cancel: "Annuler",
                supprimer: {
            ...
            .then((value) => {
                if (value === "supprimer") {
                    ...
                    axios
                        .put(`${import.meta.env.VITE_URL}/ficheCour/${id}/supprimer`, { supprimer: 1 })
                        .then(function(response) {
                    ...
                    axios
                        .put(`${import.meta.env.VITE_URL}/ficheCour/${id}/archiver`, { archiver: 1 })
                        .then(function(response) {
                            swal("Archivé!", "Votre fiche de cours a été marqué comme archivé.", "success");
                            window.location.reload();
                        })
                        .catch(function(error) {
                            console.error(error);
                    ...
                    swal("Annulé", "Votre fiche de cours n'a pas été modifié.", "info");
                }
            })
            .catch(function(error) {
                console.error(error);
    ...
    return (
        <Container fluid>
                        ...
                        <div className="pagetitle">
                            ...
                            <nav>
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">Fiche de cours</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Fiche de cours des enseignants</h3>
                                            </div>
                                                                ...
                                                                <Form className='d-flex justify-content-center my-3'>
                                                                        ...
                                                                        <OverlayTrigger
                                                                            ...
                                                                            overlay={
                                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                                    <strong>Supprimer plusieurs fiches de cours</strong>.
                                                                                </Tooltip>
                                                                            }
                                                                        >
                                                                    ...
                                                                    {['bottom'].map((placement) => (
                                                                        <OverlayTrigger
                                                                            ...
                                                                            overlay={
                                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                                    <strong>Archiver plusieurs fiches de cours</strong>.
                                                                                </Tooltip>
                                                                            }
                                                                        >
                                                                    ...
                                                                    <Row className='d-flex justify-content-center mb-3'>
                                                                        ...
                                                                        <Col className='col-md-2'>
                                                                            ...
                                                                            <Form.Select aria-label="Default select example" className='mb-3' value={selectedPerso} onChange={(e) => setSelectedPerso(e.target.value)}>
                                                                                ...
                                                                                {
                                                                                    perso.length !== 0 && (
                                                                                        [...new Set(perso.map((element) => element.nomEns +' '+ element.prenomEns))].map((nom, index) => {
                                                                                            return (
                                                                    ...
                                                                    <tr style={{backgroundColor: '#1A3C30', borderBottomColor:'transparent'}} className='w-100'>
                                                                        {['right'].map((placement) => (
                                                                            <OverlayTrigger
                                                                                ...
                                                                                overlay={
                                                                                    <Tooltip id={`tooltip-${placement}`}>
                                                                                        <strong>Créer une fiche de cours</strong>.
                                                                                    </Tooltip>
                                                                                }
                                                                            >
                                                                                        ...
                                                                                        <tr key={index}>
                                                                                            ...
                                                                                            <td>
                                                                                                {['bottom'].map((placement) => (
                                                                                                    ...
                                                                                                    >
                                                                                                        <Button variant="transparent" className='mb-3 ms-3' > <Link to={`/enseignant/voir_fiche_cours/${element.id}`}><FaEye className="text-warning" style={{ cursor:'pointer' }} /></Link></Button>
                                                                                                    </OverlayTrigger>
                                                                                                ))}
                                                                                            </td>
                                                                                            <td>
            ...
            <Modal show={show} size="lg" onHide={handleClose} aria-labelledby="contained-modal-title-vcenter" centered>
                <Modal.Header closeButton className='bg-secondary text-white'>
                    <Modal.Title id="contained-modal-title-vcenter" className='fw-4' >Ajouter une fiche de cours</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default FicheCoursEnseignant;