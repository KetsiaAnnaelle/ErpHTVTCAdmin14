...
const CreateFicheCoursPdf = ({ perso }) => {
            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.container}>
                    ...
                    <View>
                        ...
                        <View>
                            <Text style={styles.info}>
                                <Text style={styles.bolds}>{perso.nomEns + ' ' + perso.prenomEns}</Text>
                            </Text>
                            <Text style={styles.info}>
                                Filière: <Text style={styles.bold}>{perso.nomForm}</Text>
                            </Text>
                            <Text style={styles.info}>
                                Cours: <Text style={styles.bold}>{perso.nomCours}</Text>
                            </Text>
                            <Text style={styles.info}>
                                <Text style={styles.bold}>{perso.villeEns}</Text>
                            </Text>
                            <Text style={styles.info}>
                ...
                <View style={styles.tableContainer}>
                    <Text style={styles.title}>Informations sur la fiche de cours</Text>
                    <View style={styles.tableRow}>
                        <Text style={styles.tableCellHeader}>Date</Text>
                        <Text style={styles.tableCellHeader}>Description</Text>
                    </View>
                    <View style={styles.tableRow}>
                        <Text style={styles.tableCell}>{formatdate}</Text>
...
const VoirFicheCoursEns = () => {
    ...
    async function getFicheTravail() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/ficheCour/${id}`);
                ...
                <Col className='col-lg-12'>
                    <main id="main" className="main">
                        ...
                        <div className="pagetitle">
                            <h1>Voir Fiche de cours</h1>
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/personnel/fiche_travail">Fiches de cours</NavLink></li>
                                    <li className="breadcrumb-item active">Voir fiche de cours</li>
                                </ol>
                            </nav>
                        </div>
                                                    ...
                                                    <div className="col-12">
                                                        <div className="card">
                                                            <div className="card-body table-responsive p-0">
                                                                <div className="card">
                                                                    <div className="card-header">
                                                                        <h3 className="card-title">Fiche de cours du {formatdate} de Mr/Mme {perso.nomPerso+' '+perso.prenomPerso}</h3>
                                                                    </div>
                                                                    <div className="card-body">
                                                                        <div className="row">
                                                                            <div className="col-12">
                                                                                    ...
                                                                                    <div className="card-body table-responsive p-0">
                                                                                        <div className='d-flex justify-content-between'>
                                                                                            ...
                                                                                            <Card className='border-0 p-3'>
                                                                                                <Card.Body>
                                                                                                    <Card.Text>
                                                                                                        Noms Personnel : <span> {perso.nomEns +' '+ perso.prenomEns}</span>
                                                                                                    </Card.Text>
                                                                                                    <Card.Text>
                                                                                                        Filière : <span> {perso.nomForm}</span>
                                                                                                    </Card.Text>
                                                                                                    <Card.Text>
                                                                                                        Cours : <span> {perso.nomCours}</span>
                                                                                                    </Card.Text>
                                                                                                    <Card.Text>
                                                                                                        Matricule : <span> HTTVCP0{perso.enseignant_id}</span>
                                                                                                    </Card.Text>
                                                                                                </Card.Body>
                                                                                            </Card>
                                                                                        </div>
                                                                                            ...
                                                                                            <div className="row g-0">
                                                                                                <div className="col">
                                                                                                    <div className="card-body">
                                                                                                                ...
                                                                                                                <OverlayTrigger
                                                                                                                    ...
                                                                                                                    overlay={
                                                                                                                        <Tooltip id={`tooltip-${placement}`}>
                                                                                                                            <strong>Télécharger la fiche de cours</strong>.
                                                                                                                        </Tooltip>
                                                                                                                    }
                                                                                                                >
                                                                                                                    <Button variant="transparent" className='mb-3 ms-3'>
                                                                                                                        <PDFDownloadLink document={<CreateFicheCoursPdf perso={perso}/>} fileName='ficheCours'>
                                                                                                        ...
                                                                                                        <ListGroup>
                                                                                                            <ListGroup.Item>
                                                                                                                <p><span className='fs-6 my-3'>Noms et prénoms de l'enseignant </span><span className='fw-bold ms-3'>{perso.nomEns+' '+perso.prenomEns }</span></p>
...
export default VoirFicheCoursEns;