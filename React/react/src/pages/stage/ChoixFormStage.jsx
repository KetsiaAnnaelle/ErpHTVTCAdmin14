...
const ChoixFormStage = () => {
    ...
    async function getStageParFiliere() {
        try {
            setload(true)
            const response = await axios.get(`${import.meta.env.VITE_URL}/stages/nombre`);
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Choisissez une formation pour créer une liste de stage</h3>
                                            </div>
                                                                                    ...
                                                                                    return(
                                                                                        <>
                                                                                            <Col className='col-md-3 col-lg-3 mb-3'>
                                                                                                <Link to={`/stage_formation/${element.nomForm}`} className='text-center fw-1 text-dark' style={{ textDecoration:'none' }}>
