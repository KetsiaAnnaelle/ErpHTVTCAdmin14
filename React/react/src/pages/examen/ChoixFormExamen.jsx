                ...
                <Col className='col-lg-12'>
                    <main id="main" className="main">
                        ...
                        <div className="pagetitle">
                            <h1>Choisizzez une formation</h1>
                            <nav>
                                                                                    ...
                                                                                    return(
                                                                                        <>
                                                                                            <Col className='col-md-3 col-lg-2 mb-3'>
                                                                                                <Link to={`/examen/${element.nomForm}`} className='text-center fw-1 fs-5text-dark' style={{ textDecoration:'none' }}>
...
export default ChoixFormExamen;