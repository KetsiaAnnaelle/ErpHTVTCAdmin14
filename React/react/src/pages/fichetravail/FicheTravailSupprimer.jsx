...
// fonction pour lister les abscences
    ...
    async function getFicheTravails() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/ficheTravailsSupprimer`);
    ...
    const handleDeleteSelected = () => {
        ...
        if (check.length==0 || selectedRecords.length==0){
            ...
            axios.put(`${import.meta.env.VITE_URL}/ficheTravail/element`, {
                data: selectedRecords,
            })
                .then(function (response) {
                    swal("Supprimées !", "Les fiches de travail sélectionnées ont été supprimé définitivement.", "success");
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/ficheTravail/elementRestaure`, { ids: selectedRecords })
            .then(function (response) {
                swal("Restauré !", "Les fiches de ravail sélectionnés ont été restauré.", "success");
                window.location.reload();
            })
            .catch(function (error) {
                console.error(error);
    ...
    const delFicheTravail = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    axios
                        .delete(`${import.meta.env.VITE_URL}/ficheTravail/` + id)
                        .then(function(response) {
                ...
                <Col className='col-lg-12'>
                    <main id="main" className="main">
                        ...
                        <div className="pagetitle">
                            <h1>Corbeille fiches de travail</h1>
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/personnel/fiche_travail">Fiches de travail</NavLink></li>
                                    <li className="breadcrumb-item active">Corbeille fiches de travail</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste des fiches de travail dans la corbeille</h3>
                                            </div>
...
export default FicheTravailSupprimer;