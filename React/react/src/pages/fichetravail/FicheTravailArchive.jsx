...
const FicheTravailArchive = () => {
    ...
    const keys=['postePerso', 'diplomePerso','typeContratPerso', 'nomPerso'];
...
// fonction pour lister les abscences
    ...
    async function getFicheTravails() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/ficheTravailsArchiver`);
    ...
    const handleSupprimeSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/ficheTravail/elementSupprime`, { ids: selectedRecords })
            .then(function (response) {
                swal("Supprimé !", "Les fiches de travail sélectionnées ont été supprimé.", "success");
    ...
    const handleRestauresSelected = () => {
        ...
        axios.put(`${import.meta.env.VITE_URL}/ficheTravail/elementRestaure`, { ids: selectedRecords })
            .then(function (response) {
                swal("Restauré !", "Les fiches de travail sélectionnés ont été restauré.", "success");
                window.location.reload();
            })
            .catch(function (error) {
                console.error(error);
    ...
    const delFicheTravail = async (id) => {
        swal({
            ...
            text: "Vous risquez de ne plus pouvoir restaurer cette fiche de travail !",
            icon: "warning",
            buttons: {
        ...
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    ...
                    axios
                        .put(`${import.meta.env.VITE_URL}/ficheTravail/${id}/archiverRestaurer`, { archiver: 0 })
                        .then(function(response) {
                            swal("Restauré!", "Votre fiche de travail a été marquée comme Restauré.", "success");
                            window.location.reload()
                        })
                        .catch(function(error) {
                            console.error(error);
                ...
                <Col className='col-lg-12'>
                    <main id="main" className="main">
                        ...
                        <div className="pagetitle">
                            <h1>Fiches de travail archivées</h1>
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/personnel/fiche_travail">Fiches de travail</NavLink></li>
                                    <li className="breadcrumb-item active">Fiches de travail archivées</li>
                                </ol>
                            </nav>
                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="card">
                                            <div className="card-header">
                                                <h3 className="card-title">Liste des fiches de travail archivées</h3>
                                            </div>
                                                                ...
                                                                <Form className='d-flex justify-content-center my-3' >
                                                                    ...
                                                                    {['bottom'].map((placement) => (
                                                                        <OverlayTrigger
                                                                            ...
                                                                            overlay={
                                                                                <Tooltip id={`tooltip-${placement}`}>
                                                                                    <strong>Restaurer plusieurs fiches de travail</strong>.
                                                                                </Tooltip>
                                                                            }
                                                                        >
                                                                                            ...
                                                                                            <td>
                                                                                                {['bottom'].map((placement) => (
                                                                                                    <OverlayTrigger
                                                                                                        ...
                                                                                                        overlay={
                                                                                                            <Tooltip id={`tooltip-${placement}`}>
                                                                                                                <strong>Restaurer fiche de travail</strong>.
                                                                                                            </Tooltip>
                                                                                                        }
                                                                                                    >
                                                                                            ...
                                                                                            <td>
                                                                                                {['bottom'].map((placement) => (
                                                                                                    <OverlayTrigger
                                                                                                        ...
                                                                                                        overlay={
                                                                                                            <Tooltip id={`tooltip-${placement}`}>
                                                                                                                <strong>Supprimer fiche de travail</strong>.
                                                                                                            </Tooltip>
                                                                                                        }
                                                                                                    >
...
export default FicheTravailArchive;