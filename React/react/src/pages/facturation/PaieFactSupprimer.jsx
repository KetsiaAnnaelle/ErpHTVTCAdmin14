...
const PaieFactSupprimer = () => {
    ...
    async function getPaiementSupprimer() {
        try {
            setload(true)
            const response = await axios.get(`${import.meta.env.VITE_URL}/get-paiement-Facture-supprimer`);
...
export default PaieFactSupprimer;