...
function MyVerticallyCenteredModal(props) {
 ...
 await axios.post(`${import.meta.env.VITE_URL}/performanceEns/${props.data.id}`,{
 'respDelaiEns': data.respDelai,
 'assuidEns': data.assuid,
 'travailEns': data.travail,
 'savoirVivrEns': data.savoirVivr,
 'note': data.note,
 })
 ...
 defaultValue={props.data.respDelaiEns}>
 ...
 defaultValue={props.data.assuidEns}>
 ...
 defaultValue={props.data.travailEns}>
 ...
 defaultValue={props.data.savoirVivrEns}>
...
const PerformanceEns = () => {
 ...
 async function getPerformancesEns() {
 try {
 const response = await axios.get(`${import.meta.env.VITE_URL}/performancesEns`);
 ...
 formData.append('respDelaiEns', data.respDelai);
 formData.append('assuidEns', data.assuid);
 formData.append('travailEns', data.travail);
 formData.append('savoirVivrEns', data.savoirVivr);
 formData.append('note', data.note);

 axios.post(`${import.meta.env.VITE_URL}/performancesEns`,formData)
 .then(function (response) {
 console.log(response.data);
 JSON.stringify(response.data)
 setShow(false)
 ...
 axios.put(`${import.meta.env.VITE_URL}/performanceEns/element`, {
 ...
 axios.put(`${import.meta.env.VITE_URL}/performanceEns/elementRestaures`, { ids: selectedRecords })
 .then(function (response) {
 swal("Restaurées !", "Les performances sélectionnées ont été archivé.", "success");
 window.location.reload();
 })
 .catch(function (error) {
 console.error(error);
 ...
 axios.put(`${import.meta.env.VITE_URL}/performanceEns/elementSupprime`, { ids: selectedRecords })
 .then(function (response) {
 ...
 axios
 .put(`${import.meta.env.VITE_URL}/performanceEns/${id}/supprimer`, { supprimer: 1 })
 .then(function(response) {
 ...
 axios
 .put(`${import.meta.env.VITE_URL}/performanceEns/${id}/archiver`, { archiver: 1 })
 .then(function(response) {
 ...
 <h3 className="card-title">Liste des rapports sur la performance des enseignants</h3>
 </div>
 ...
 <td>{mentions[element.respDelaiEns-1]}</td>
 <td>{mentions[element.assuidEns-1]}</td>
 <td>{mentions[element.travailEns-1]}</td>
 <td>{mentions[element.savoirVivrEns-1]}</td>
 <td>{element.note}</td>
 </tr>
