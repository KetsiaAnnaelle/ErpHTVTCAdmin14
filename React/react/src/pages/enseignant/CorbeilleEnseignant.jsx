...
// fonction pour lister les abscences
    ...
    async function getEnseignants() {
        try {
            const response = await axios.get(`${import.meta.env.VITE_URL}/enseignantsSupprimer`);
    ...
    const handleDeleteSelected = () => {
        ...
        if (check.length==0 || selectedRecords.length==0){
            ...
            axios.put(`${import.meta.env.VITE_URL}/enseignant/element`, {
                data: selectedRecords,
            })
                .then(function (response) {
                    swal("Supprimées !", "Les enseignants sélectionnés ont été supprimé définitivement.", "success");
    ...
    const delPersonnel = async (id) => {
        swal({
            ...
            .then((isConfirm) => {
                if (isConfirm) {
                    axios
                        .delete(`${import.meta.env.VITE_URL}/enseignant/` + id)
                        .then(function(response) {
                        ...
                        <div className="pagetitle">
                            ...
                            <nav>
                                <ol className="breadcrumb">
                                    <li className="breadcrumb-item"><NavLink to="/recrutement_enseignant">Recrutements</NavLink></li>
...
export default CorbeilleEnseignant;