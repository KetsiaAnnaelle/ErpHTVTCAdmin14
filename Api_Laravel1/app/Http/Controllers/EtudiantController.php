...
class EtudiantController extends Controller
{
    ...
    public function GetStudentsByClass(string $filiere){
        ...
        $Students = DB::table('inscription_etudiants')
            ->join('formations', 'formations.id', '=', 'inscription_etudiants.formation_id')
            ->select('inscription_etudiants.id', 'formations.nomForm', 'inscription_etudiants.nomEtud', 'inscription_etudiants.prenomEtud',
            'inscription_etudiants.section', 'inscription_etudiants.formation_id','inscription_etudiants.birthday',)
