    ...
    /**
        ...
        public function index()
        {
            ...
            $factures = DB::table('factures')
                ...
                'factures.status','inscription_etudiants.nomEtud','inscription_etudiants.prenomEtud','factures.etudiant_id','factures.id','factures.archiver','factures.supprimer')
        ...
        public function FactureParFiliere()
        {
            try {
                $facture = DB::table('formations')
                    ...
                    ->select(DB::raw('formations.id, formations.nomForm, factures.archiver, factures.supprimer, COALESCE(COUNT(factures.id), 0) as nombre'))
