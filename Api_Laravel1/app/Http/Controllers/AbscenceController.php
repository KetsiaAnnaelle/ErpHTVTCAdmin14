     ...
     public function AbsenceParFiliere()
{
    try {
        $absence = DB::table('formations')
            ...
            ->select(DB::raw('formations.id, formations.nomForm, abscences.archiver, abscences.supprimer, COALESCE(SUM(abscences.nbreHeureAbs), 0) as nombre'))
